...
public class PDFTagsTestCase {
    ...
    public void testPDF() throws Exception {
        ...
        String fo = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><fo:root xmlns:fo=\"http://www.w3.org/1999/XSL/Format\""
                + " xmlns:pdf=\"http://xmlgraphics.apache.org/fop/extensions/pdf\""
                + " xmlns:fox=\"http://xmlgraphics.apache.org/fop/extensions\" font-family=\"Univers\">\n"
                ...
                + "      <fo:block>Link 1: <fo:basic-link external-destination=\"https://www.iso.org\""
                + " fox:alt-text=\"iso.org\">www.iso.org</fo:basic-link></fo:block>\n"
                + "      <fo:block>Link 2: <fo:basic-link external-destination=\"mailto:iso@iso.org\""
                + " fox:alt-text=\"iso@iso.org\">iso@iso.org</fo:basic-link></fo:block>\n"
                + "      <fo:block>Link 3: <fo:basic-link internal-destination=\"foreword\""
                + " fox:alt-text=\"Foreword\">Foreword</fo:basic-link></fo:block>\n"
                + "      <fo:block>Link 4: <fo:basic-link internal-destination=\"scope\""
                + " fox:alt-text=\"Link&#xa0;to&#xa0;Scope\">Scope</fo:basic-link></fo:block>\n"
                + "      <fo:block>Link 5: <fo:basic-link internal-destination=\"scope\""
                + " fox:alt-text=\"Link&#xa0;to&#xa0;Scope\">Scope</fo:basic-link></fo:block>\n"
                ...
                + "      <fo:block>Text <fo:block><fo:block-container><fo:block>Div inside P</fo:block>"
                + "</fo:block-container></fo:block></fo:block>\n"
                + "    </fo:flow>\n"
                + "  </fo:page-sequence>\n"
                + "</fo:root>\n";
    ...
    private void checkPDF(byte[] data) throws IOException {
        ...
        // check for "Add /T (title) for <Sect>" (https://github.com/metanorma/xmlgraphics-fop/issues/67)
        Assert.assertTrue(objects.contains("/T (Scope)"));
        // check for "Annotation flags (Ff) for all Link annotations"
        // (https://github.com/metanorma/xmlgraphics-fop/issues/72)
        Assert.assertTrue(!objects.contains("/Contents (https://www.iso.org)\n"
                + "/F 28"));
        Assert.assertTrue(objects.contains("/Contents (https://www.iso.org)\n"
                + "/F 4"));
